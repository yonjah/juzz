...
const ExampleTools = Object.assign({
    ...
    genExample(origDesc, retry = 10) {
        ...
        Object.keys(rules.refs).forEach((ruleKey) => {
            ...
            const refRes = alter(this.addChildRef(refKey, ruleKey, desc, { type: desc.type === 'date' ? 'date' : 'number' }));
