...
function setDebugColor (debug) {
	debug.color = debugColors[debugColor];
...
const knownKeys = {
	...
	flags: ['allowOnly', 'presence', 'insensitive', 'default', 'trim', 'sparse', 'single', 'momentFormat', 'raw', 'empty', 'case', 'truncate',
		'normalize', 'ref', 'format', 'timestamp', 'multiplier', 'precision', 'func', 'byteAligned', 'allowUnknown', 'strip'],
	options: ['language', 'convert', 'presence', 'stripUnknown', 'abortEarly', 'allowUnknown'],
	object: baseKeys.concat(['children', 'dependencies', 'patterns']),
...
module.exports = { debug, setDebugColor, knownKeys, chance, RandExp };